...
function Tokens() {
  ...
  <div className="ETHDEX">
      ...
      <div className="text">
        <span className="text-item">Tokens</span>
        <span className="text-item">Market Cap</span>
          ...
          : cryptos
              ...
              .map((token, index) => (
                <div className="cardContainer" key={index}>
                  {!selectedToks.includes(token.uuid) ? null : 
                    ...
                    <Link to={`/${token?.name}/${token?.uuid}`}>
                      <div className="cardContainer" >
                        ...
                        <img className="logo" src={token.iconUrl} alt="noLogo" />
                          <span className="symbol">{token.symbol} <br /> <br />{token.name}</span>
                        </div>
                          <span className="type">
